...
class JojosBizarreSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = JojosBizarreHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = JojosBizarreHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!JojosBizarreFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, JojosBizarreFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return JojosBizarreUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = JojosBizarreHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = JojosBizarreHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = JojosBizarreHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new JojosBizarreError($op . "_allow",
                "JojosBizarreSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = JojosBizarreHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new JojosBizarreError("graphql_error",
                "JojosBizarreSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Stand($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_stand === null) {
                $this->_stand = new StandEntity($this, null);
            }
            return $this->_stand;
        }
        return new StandEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new JojosBizarreSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
