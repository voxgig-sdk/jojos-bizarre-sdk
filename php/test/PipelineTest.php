...
// JojosBizarre SDK pipeline test
//
...
{
    private static function utility(): JojosBizarreUtility
    {
        return new JojosBizarreUtility();
    }
    ...
    private static function ctx(array $over = []): JojosBizarreContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new JojosBizarreContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new JojosBizarreOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof JojosBizarreError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new JojosBizarreOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = JojosBizarreMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new JojosBizarreOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = JojosBizarreMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new JojosBizarreOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = JojosBizarreMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JojosBizarreSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = JojosBizarreMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new JojosBizarreResponse([]),
            'result' => new JojosBizarreResult([]),
        ]);
        [, $err] = JojosBizarreMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new JojosBizarreSpec([]),
            'response' => null,
            'result' => new JojosBizarreResult([]),
        ]);
        [, $err] = JojosBizarreMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new JojosBizarreSpec(['step' => 's']),
            'response' => new JojosBizarreResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new JojosBizarreResult([]),
        ]);
        [, $err] = JojosBizarreMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new JojosBizarreSpec(['step' => 's']),
            'response' => new JojosBizarreResponse(self::resp(200, ['v' => 1])),
            'result' => new JojosBizarreResult([]),
        ]);
        [, $err] = JojosBizarreMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new JojosBizarreSpec(['step' => 's']),
            'response' => new JojosBizarreResponse(self::resp(200, ['v' => 2])),
            'result' => new JojosBizarreResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        JojosBizarreMakeResponse::call($ctx);
    ...
    {
        $preset = new JojosBizarreResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new JojosBizarreSpec([]),
            'response' => new JojosBizarreResponse([]),
            'result' => new JojosBizarreResult([]),
        ...
        [$got, $err] = JojosBizarreMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new JojosBizarreResult([])]);
        [, $err] = JojosBizarreMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new JojosBizarreSpec([]), 'result' => null]);
        [, $err] = JojosBizarreMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JojosBizarreSpec(['step' => 's']),
            'result' => new JojosBizarreResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new JojosBizarreOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JojosBizarreMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new JojosBizarreSpec(['step' => 's']),
            'result' => new JojosBizarreResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new JojosBizarreOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = JojosBizarreMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new JojosBizarreResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new JojosBizarreSpec([]),
            'result' => new JojosBizarreResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = JojosBizarreMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JojosBizarreMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new JojosBizarreError('boom', 'boom');
        $utility->fetcher = function (JojosBizarreContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JojosBizarreSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = JojosBizarreMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (JojosBizarreContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = JojosBizarreMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(JojosBizarreResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        JojosBizarreMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (JojosBizarreContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new JojosBizarreSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = JojosBizarreMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new JojosBizarreResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new JojosBizarreSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = JojosBizarreMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = JojosBizarreMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = JojosBizarreMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new JojosBizarreResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, JojosBizarreDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new JojosBizarreResult(['ok' => false])]);
        $this->expectException(JojosBizarreError::class);
        JojosBizarreDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new JojosBizarreResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', JojosBizarreMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        JojosBizarreMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new JojosBizarreBaseFeature();
        $b = new JojosBizarreBaseFeature();
        JojosBizarreFeatureAdd::call($ctx, $a);
        JojosBizarreFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): JojosBizarreBaseFeature
    {
        $f = new JojosBizarreBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        JojosBizarreFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): JojosBizarreContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new JojosBizarreSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = JojosBizarrePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        JojosBizarrePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new JojosBizarreResponse(['headers' => null]),
            'result' => new JojosBizarreResult([]),
        ]);
        JojosBizarreResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        JojosBizarreResultBody::call($ctx);
