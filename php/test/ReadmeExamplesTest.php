...
// JojosBizarre SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JojosBizarreSDK::test)
...
{
    private const SDK_CLASS = 'JojosBizarreSDK';
    ...
    private const SDK_BASE = 'jojosbizarre_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jojosbizarre_sdk.php';
