...
// JojosBizarre SDK utility type

class JojosBizarreUtility
{
    ...
    public static function copy(JojosBizarreUtility $src): JojosBizarreUtility
    {
        $u = new JojosBizarreUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
