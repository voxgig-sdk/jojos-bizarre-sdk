...
// JojosBizarre SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class JojosBizarreTransformResponse
{
    public static function call(JojosBizarreContext $ctx): mixed
    {
        ...
        $transform = JojosBizarreHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
