...
// JojosBizarre SDK utility: fetcher

class JojosBizarreFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JojosBizarreSDK/1.0)';
    ...
    public static function call(JojosBizarreContext $ctx, string $fullurl, array $fetchdef): array
    {
