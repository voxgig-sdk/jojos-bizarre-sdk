...
// JojosBizarre SDK utility: graphql
//
...
class JojosBizarreGraphql
{
    ...
    // equivalent.
    public static function body(JojosBizarreContext $ctx): mixed
    {
    ...
    public static function errors(JojosBizarreContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
