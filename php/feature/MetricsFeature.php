...
// JojosBizarre SDK metrics feature
...
class JojosBizarreMetricsFeature extends JojosBizarreBaseFeature
{
    ...
    private function _record(JojosBizarreContext $ctx, bool $ok): void
    {
