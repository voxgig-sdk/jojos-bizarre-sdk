...
// JojosBizarre SDK audit feature
...
class JojosBizarreAuditFeature extends JojosBizarreBaseFeature
{
    ...
    private function _emit(JojosBizarreContext $ctx, string $outcome): void
    {
