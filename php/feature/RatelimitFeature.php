...
// JojosBizarre SDK ratelimit feature
...
class JojosBizarreRatelimitFeature extends JojosBizarreBaseFeature
{
    ...
    private function _acquire(JojosBizarreContext $ctx): void
    {
    ...
    private function _track(JojosBizarreContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
