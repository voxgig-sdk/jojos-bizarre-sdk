...
// JojosBizarre SDK netsim feature
...
class JojosBizarreNetsimFeature extends JojosBizarreBaseFeature
{
    ...
    private function _simulate(JojosBizarreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JojosBizarreContext $ctx, array $applied): void
    {
        $client = $this->client;
