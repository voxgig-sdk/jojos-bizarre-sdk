...
class JojosBizarreRbacFeature extends JojosBizarreBaseFeature
{
    ...
    private function _required(JojosBizarreContext $ctx): ?string
    {
    ...
    private function _reject(JojosBizarreContext $ctx, string $required): void
    {
    ...
    private function _track(JojosBizarreContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
