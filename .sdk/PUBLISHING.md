...
|---|---|---|
| `ts/` | @voxgig-sdk/jojos-bizarre-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/jojos-bizarre-sdk \
      --repository voxgig-sdk/jojos-bizarre-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/jojos-bizarre-sdk` shows it, and
`npm trust revoke @voxgig-sdk/jojos-bizarre-sdk --id=<id>` removes it.
