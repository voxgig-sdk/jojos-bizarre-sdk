...
// JojosBizarre SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JojosBizarreOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JojosBizarreOmni::structfix($now, Struct::undef()))
                        !== json_encode(JojosBizarreOmni::structfix($val, Struct::undef()))) {
