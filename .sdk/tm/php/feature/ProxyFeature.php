...
// JojosBizarre SDK proxy feature
...
class JojosBizarreProxyFeature extends JojosBizarreBaseFeature
{
    ...
    public function init(JojosBizarreContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JojosBizarreContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
