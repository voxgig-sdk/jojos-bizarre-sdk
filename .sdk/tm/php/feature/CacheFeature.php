...
// JojosBizarre SDK cache feature
...
class JojosBizarreCacheFeature extends JojosBizarreBaseFeature
{
    ...
    private function _through(JojosBizarreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
