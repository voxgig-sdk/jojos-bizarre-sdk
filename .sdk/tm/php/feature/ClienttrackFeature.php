...
// JojosBizarre SDK clienttrack feature
...
class JojosBizarreClienttrackFeature extends JojosBizarreBaseFeature
{
    ...
    public function PostConstruct(JojosBizarreContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'JojosBizarre-SDK';
