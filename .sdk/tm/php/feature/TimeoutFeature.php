...
// JojosBizarre SDK timeout feature
...
class JojosBizarreTimeoutFeature extends JojosBizarreBaseFeature
{
    ...
    private function _with_timeout(JojosBizarreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JojosBizarreContext $_ctx, float $ms): void
    {
        $client = $this->client;
