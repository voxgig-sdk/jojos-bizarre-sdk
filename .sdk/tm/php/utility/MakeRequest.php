...
// JojosBizarre SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class JojosBizarreMakeRequest
{
    public static function call(JojosBizarreContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new JojosBizarreResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new JojosBizarreResponse($fetched);
        } else {
