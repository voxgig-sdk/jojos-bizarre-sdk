...
// JojosBizarre SDK utility: make_options

class JojosBizarreMakeOptions
{
    ...
    public static function call(JojosBizarreContext $ctx): array
    {
        ...
        //
        // `JojosBizarreSchema::optspec()` is built from the model:
        ...
        $optspec = JojosBizarreSchema::optspec();
