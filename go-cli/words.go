...
func registerSDKWords(r *eng.Registry, client *sdk.JojosBizarreSDK) {
...
func runOp(client *sdk.JojosBizarreSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
