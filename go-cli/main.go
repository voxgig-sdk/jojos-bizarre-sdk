// Command JojosBizarre-cli is a CLI + REPL for the JojosBizarre SDK,
...
const prompt = "jojos-bizarre"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "character stand"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      JOJOS_BIZARRE_APIKEY (api key), JOJOS_BIZARRE_BASE (base url override)")
