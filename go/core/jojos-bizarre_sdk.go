...
func (sdk *JojosBizarreSDK) OptionsMap() map[string]any {
...
func (sdk *JojosBizarreSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *JojosBizarreSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *JojosBizarreSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JojosBizarreSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *JojosBizarreSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *JojosBizarreSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("JojosBizarreSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *JojosBizarreSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JojosBizarreSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("JojosBizarreSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *JojosBizarreSDK {
	...
	sdk := NewJojosBizarreSDK(sdkopts)
	sdk.Mode = "test"
