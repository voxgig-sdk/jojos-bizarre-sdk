...
func NewStandEntity(client *core.JojosBizarreSDK, entopts map[string]any) *StandEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StandEntity) GetName() string { return e.name }
...
func (e *StandEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StandEntity) Deleted() bool {
	return e.deleted
}


func (e *StandEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStandEntity(e.client, opts)
}

func (e *StandEntity) Data(args ...any) any {
...
func (e *StandEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Stand; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StandEntity) DataTyped(data ...Stand) Stand {
	if len(data) > 0 {
		return typedFrom[Stand](e.Data(asMap(data[0])))
	}
	return typedFrom[Stand](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Stand (all fields
// optional at the wire level).
func (e *StandEntity) MatchTyped(match ...Stand) Stand {
	if len(match) > 0 {
		return typedFrom[Stand](e.Match(asMap(match[0])))
	}
	return typedFrom[Stand](e.Match())
}
...
func (e *StandEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StandEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StandLoadMatch and returns an Stand. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StandEntity) LoadTyped(reqmatch StandLoadMatch, ctrl map[string]any) (Stand, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Stand{}, err
	}
	return typedFrom[Stand](res), nil
}




func (e *StandEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// StandListMatch and returns []Stand. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StandEntity) ListTyped(reqmatch StandListMatch, ctrl map[string]any) ([]Stand, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Stand](res), nil
}



func (e *StandEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StandEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StandEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StandEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
