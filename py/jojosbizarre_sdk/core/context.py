...
from jojosbizarre_sdk.core.helpers import get_ctx_prop, to_map
...
class JojosBizarreContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, JojosBizarreSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JojosBizarreResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JojosBizarreResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return JojosBizarreError(code, msg, self)
