...
from jojosbizarre_sdk.utility import register

# Load features
from jojosbizarre_sdk.feature.base_feature import JojosBizarreBaseFeature
from jojosbizarre_sdk.features import _has_feature, _make_feature
...
class JojosBizarreSDK:
    ...
    def get_utility(self):
        return JojosBizarreUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JojosBizarreSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from jojosbizarre_sdk.entity.character_entity import CharacterEntity
    ...
    def Stand(self, data=None) -> "StandEntity":
        ...
        from jojosbizarre_sdk.entity.stand_entity import StandEntity
