# JojosBizarre SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JojosBizarreSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JojosBizarreSDK(...) and JojosBizarreSDK.test(...) become
#      JojosBizarreSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jojosbizarre_sdk"
_SDK_CLASS = "JojosBizarreSDK"
