...
class JojosBizarreTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JojosBizarreTestRunner.getenv("JOJOSBIZARRE_TEST_LIVE")
        override = JojosBizarreTestRunner.getenv("JOJOSBIZARRE_TEST_OVERRIDE")
        ...
        explain = JojosBizarreTestRunner.getenv("JOJOSBIZARRE_TEST_EXPLAIN")
