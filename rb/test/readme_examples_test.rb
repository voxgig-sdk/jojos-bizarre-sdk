...
#      offline in seeded test mode (JojosBizarreSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "JojosBizarre_sdk.rb")
  SDK_CLASS = "JojosBizarreSDK"
