# JojosBizarre Ruby SDK Reference

Complete API reference for the JojosBizarre Ruby SDK.
...
```ruby
require_relative 'jojos-bizarre_sdk'
...
#### `JojosBizarreSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Stand.list(nil)
```
