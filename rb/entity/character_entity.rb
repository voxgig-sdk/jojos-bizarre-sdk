# JojosBizarre SDK Character entity
...
class CharacterEntity
  ...
  # @return [Character, Hash] the loaded Character; raises JojosBizarreError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Character>, Array] the matching Character items; raises JojosBizarreError on failure
