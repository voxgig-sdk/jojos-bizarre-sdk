// Command JojosBizarre-mcp is an MCP server exposing the JojosBizarre
// SDK as MCP tools.
//
// Two tools are registered:
//
//	JojosBizarre_list  — list records of an entity
//	JojosBizarre_load  — load a single record of an entity
//
