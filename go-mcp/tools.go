...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | stand"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JojosBizarreSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "jojos-bizarre_list",
		Description: "List records from JojosBizarre. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "jojos-bizarre_load",
		Description: "Load a single record from JojosBizarre. " +
...
func runOp(client *sdk.JojosBizarreSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JojosBizarreSDK, name string) (sdk.JojosBizarreEntity, error) {
	switch strings.ToLower(name) {
	case "character":
		return client.Character(nil), nil
	case "stand":
		return client.Stand(nil), nil
