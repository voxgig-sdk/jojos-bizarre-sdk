...
This is an unofficial SDK for the Jojo's Bizarre public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/jojos-bizarre` | `npm install @voxgig-sdk/jojos-bizarre` |
| Python | `voxgig-sdk-jojos-bizarre` | `pip install voxgig-sdk-jojos-bizarre` |
| PHP | `voxgig-sdk/jojos-bizarre` | `composer require voxgig-sdk/jojos-bizarre` |
| Golang | `github.com/voxgig-sdk/jojos-bizarre-sdk/go` | `go get github.com/voxgig-sdk/jojos-bizarre-sdk/go` |
| Ruby | `voxgig-sdk-jojos-bizarre` | `gem install voxgig-sdk-jojos-bizarre` |
| Lua | `voxgig-sdk-jojos-bizarre` | `luarocks install voxgig-sdk-jojos-bizarre` |
...
- Upstream API: [https://jojos-bizarre-api.netlify.app/](https://jojos-bizarre-api.netlify.app/)
