...
This API provides access to detailed information about characters and stands from the Jojo's Bizarre Adventure series.

Learn more about Jojo's Bizarre API at [stand-by-me.herokuapp.com](https://stand-by-me.herokuapp.com).
...
This SDK exposes the API as a small set of **semantic entities** — Character and Stand — that you
...
| **Stand** | The Stand entity (list, load). | `/api/stands` |
