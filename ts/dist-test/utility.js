...
function envOverride(m) {
    if ('TRUE' === process.env.JOJOS_BIZARRE_TEST_LIVE ||
        'TRUE' === process.env.JOJOS_BIZARRE_TEST_OVERRIDE) {
    ...
    m.JOJOS_BIZARRE_TEST_EXPLAIN = process.env.JOJOS_BIZARRE_TEST_EXPLAIN || m.JOJOS_BIZARRE_TEST_EXPLAIN;
    return m;
}
