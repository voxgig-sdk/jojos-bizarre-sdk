# JojosBizarre Lua SDK



The Lua SDK for the JojosBizarre API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/jojos-bizarre-sdk/releases)),
...
| --- | --- | --- |
| `abilities` | `table` | List of character abilities |
...
Create an instance: `local stand = client:Stand(nil)`
...
| Field | Type | Description |
| --- | --- | --- |
| `abilities` | `table` | List of stand abilities |
...
```lua
local stand, err = client:Stand():load({ id = "stand_id" })
```

#### Example: List

```lua
local stands, err = client:Stand():list()
```
...
```
lua/
├── jojos-bizarre_sdk.lua    -- Main SDK module
...
The main module (`jojos-bizarre_sdk`) exports the SDK constructor
