...
function runner.env_override(m)
  local live = runner.getenv("JOJOSBIZARRE_TEST_LIVE")
  local override = runner.getenv("JOJOSBIZARRE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JOJOSBIZARRE_TEST_EXPLAIN")
