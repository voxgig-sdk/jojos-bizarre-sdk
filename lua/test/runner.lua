...
function runner.env_override(m)
  local live = runner.getenv("JOJOS_BIZARRE_TEST_LIVE")
  local override = runner.getenv("JOJOS_BIZARRE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JOJOS_BIZARRE_TEST_EXPLAIN")
